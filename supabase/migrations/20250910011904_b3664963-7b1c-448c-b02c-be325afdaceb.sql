-- Populate database with initial data for MVP testing
...
('Residencial Vista Verde', 'Av. Jardim Verde, 456 - Bairro Verde', 'Em Planejamento', '2025-03-01'::timestamptz, '2026-02-28'::timestamptz, -23.5489, -46.6388),
('Condomínio Parque', 'Rua do Parque, 789 - Vila Nova', 'Em Andamento', '2024-10-01'::timestamptz, '2025-09-30'::timestamptz, -23.5567, -46.6512),
('Residencial Sol Nascente', 'Av. Sol Nascente, 321 - Zona Norte', 'Concluído', '2024-01-01'::timestamptz, '2024-12-31'::timestamptz, -23.5234, -46.6123);

-- Get obra IDs for referencing
-- We'll use the names to reference them in subsequent inserts
