...
('Edifício Central', 'Rua das Flores, 123 - Centro', 'em_andamento', '2025-01-15'::timestamptz, '2025-12-15'::timestamptz, -23.5505, -46.6333),
('Residencial Vista Verde', 'Av. Jardim Verde, 456 - Bairro Verde', 'planejada', '2025-03-01'::timestamptz, '2026-02-28'::timestamptz, -23.5489, -46.6388),
('Condomínio Parque', 'Rua do Parque, 789 - Vila Nova', 'em_andamento', '2024-10-01'::timestamptz, '2025-09-30'::timestamptz, -23.5567, -46.6512),
('Residencial Sol Nascente', 'Av. Sol Nascente, 321 - Zona Norte', 'concluida', '2024-01-01'::timestamptz, '2024-12-31'::timestamptz, -23.5234, -46.6123);
